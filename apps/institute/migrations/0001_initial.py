    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('image', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='awards/')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='institute_covers/')),
                ...
                ('type', models.CharField(choices=[('private', 'Private'), ('public', 'Public'), ('community', 'Community')], default='Private', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='institute_awards/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='institute.Institute')),
            ],
        ),
        migrations.CreateModel(
            name='InstituteImage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('file', versatileimagefield.fields.VersatileImageField(height_field='height', upload_to='institute_images/', width_field='width')),
                ...
                ('institute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='institute.Institute')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='institute_personnels', to='institute.Institute')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='institute_programs', to='institute.Institute')),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='institute_programs', to='program.Program')),
            ],
        ),
        migrations.CreateModel(
            name='Membership',
        ...
        migrations.AddField(
            model_name='institute',
            name='boards',
            field=models.ManyToManyField(blank=True, to='program.Board'),
        ),
        migrations.AddField(
            model_name='institute',
            name='network_institutes',
            field=models.ManyToManyField(blank=True, related_name='_institute_network_institutes_+', to='institute.Institute'),
        ),
        migrations.AddField(
            model_name='institute',
            name='personnels',
